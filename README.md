...
- **Música de cada capítulo**: preencha o campo `music` do capítulo em `BOOK` com um **link do
  YouTube**. O player usa o YouTube embutido e **oculto** (só o áudio, sem vídeo), tocando em
  segundo plano enquanto o leitor rola. No player há **Tocar** e **🔗 Trocar** (para colar/trocar
  o link na hora). Observação: alguns vídeos têm a incorporação desativada pelo dono e não tocam
  fora do YouTube — nesse caso o player avisa e basta usar outro link.
